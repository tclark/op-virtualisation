...
Containers data is stored by default in \texttt{/var/lib/lxc}. Each container has a directory containing its information.  A stopped container can be cloned with the command
