...
One issue with containers (and other forms of virtual systems) is that the data inside them is bound to the container instance.  If the container is shut down, the data is inaccessible. Also, at times it is useful to be able to share data across containers or between a container and its host system.  \emph{Volumes} provide us a way to handle these situations.
